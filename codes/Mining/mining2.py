...
tr5 = tr.unstack().ewm(halflife=5).mean().rank(axis=1, pct=True)
tr20 = tr.unstack().ewm(halflife=20).mean().rank(axis=1, pct=True)
tr60 = tr.unstack().ewm(halflife=60).mean().rank(axis=1, pct=True)
x = tr20 - tr60
#%%
# x = tr60
