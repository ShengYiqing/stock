...
def generate_factor(start_date, end_date):
    ...
    for n in n_list:
        try:
            sql = """
            CREATE TABLE `factor`.`tfactorhlmean%s` (
            ...
            pass
    sql = """
    select STOCK_CODE, TRADE_DATE, FACTOR_VALUE from tfactorhl
    ...
    for n in n_list:
        ...
        df_new.to_sql('tfactorhlmean%s'%n, engine, schema='factor', if_exists='append', index=True, chunksize=10000, method=tools.mysql_replace_into)
