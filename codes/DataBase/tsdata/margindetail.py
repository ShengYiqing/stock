...
for trade_date in trade_cal:
    df = tools.download_tushare(pro=pro, api_name='margin_detail', trade_date=trade_date,  fields=[
    "trade_date",
    "ts_code",
    "rzye",
    "rqye",
    ...
    if len(df) > 0:
        ...
        df.to_sql('ttsmargindetail', engine, schema='tsdata', index=False, if_exists='append', method=tools.mysql_replace_into)
