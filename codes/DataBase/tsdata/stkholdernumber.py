...
for stock in stock_list:
    df = tools.download_tushare(pro=pro, api_name='stk_holdernumber', start_date=start_date, ts_code=stock, fields='ts_code, ann_date, end_date, holder_num')
    ...
    if len(df) > 0:
        ...
        df.to_sql('ttsstkholdernumber', engine, schema='tsdata', index=False, if_exists='append', method=tools.mysql_replace_into)
