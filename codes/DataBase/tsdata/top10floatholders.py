...
for stock in stock_list:
    df = tools.download_tushare(pro=pro, api_name='top10_floatholders', start_date=start_date, ts_code=stock, fields='ts_code, ann_date, end_date, holder_name, hold_amount')
    ...
    if len(df) > 0:
        ...
        df.to_sql('ttstop10floatholders', engine, schema='tsdata', index=False, if_exists='append', method=tools.mysql_replace_into)
