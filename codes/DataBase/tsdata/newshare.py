...
df = tools.download_tushare(pro=pro, api_name='new_share', start_date=start_date, end_date=end_date, fields='ts_code, sub_code, name, ipo_date, issue_date, amount, market_amount, price, pe, limit_amount, funds, ballot')
