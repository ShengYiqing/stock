...
for trade_date in trade_cal:
    ...
    df = tools.download_tushare(pro=pro, api_name='block_trade', trade_date=trade_date, fields='ts_code, trade_date, price, vol, amount, buyer, seller')
    ...
    if len(df) > 0:
        ...
        df.to_sql('ttsblocktrade', engine, schema='tsdata', index=False, if_exists='append', method=tools.mysql_replace_into)
