...
def generate_factor(start_date, end_date):
    ...
    n = 5
    sql = """
    select STOCK_CODE, TRADE_DATE, FACTOR_VALUE from tfactorminmomentum
    ...
    df.to_sql('tfactorminmomentummean', engine, schema='factor', if_exists='append', index=True, chunksize=10000, method=tools.mysql_replace_into)
