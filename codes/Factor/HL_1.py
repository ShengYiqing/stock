...
def generate_factor(start_date, end_date):
    ...
    HL = HIGH - LOW
    df = HL.copy()
    df = df.rolling(60, min_periods=20).mean()
    ...
    df_new.to_sql('tfactorhl', engine, schema='factor', if_exists='append', index=True, chunksize=10000, method=tools.mysql_replace_into)
