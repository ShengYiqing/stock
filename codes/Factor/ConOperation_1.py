...
def generate_factor(start_date, end_date):
    ...
    and financial_index in ('yysr', 'zzc')
    ...
    for trade_date in trade_dates:
        ...
        con_yysr = df_tmp.set_index(['ann_date', 'stock_code']).financial_value.unstack().ewm(halflife=60, min_periods=5).mean().iloc[-1]
        ...
        con_operation = (con_yysr / zzc).dropna()
    ...
    df.to_sql('tfactorconoperation', engine, schema='factor', if_exists='append', index=True, chunksize=5000, method=tools.mysql_replace_into)
