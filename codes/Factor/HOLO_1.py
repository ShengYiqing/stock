...
def generate_factor(start_date, end_date):
    ...
    sql = """
    select t1.STOCK_CODE, t1.TRADE_DATE, t1.OPEN, t1.HIGH, t1.LOW from ttsdaily t1
    ...
    df_new.to_sql('tfactorholo', engine, schema='factor', if_exists='append', index=True, chunksize=10000, method=tools.mysql_replace_into)
