...
def generate_factor(start_date, end_date):
    ...
    for trade_date in trade_dates:
        ...
        con_profitability_improvement = (d_con_gmjlr / zzc).dropna()
        dic[trade_date] = DataFrame({
            'coi':con_operation_improvement, 
            'cpi':con_profitability_improvement
            }).rank(pct=True).mean(1)
