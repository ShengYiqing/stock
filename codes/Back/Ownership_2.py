...
def generate_factor(start_date, end_date):
    formula = """
    2*tfactortop1holders.preprocessed_factor_value
    -1*tfactorholdernum.preprocessed_factor_value
    -1*tfactorholdernumd.preprocessed_factor_value"""
    ...
    df_new.to_sql('tfactorownership', engine, schema='factor', if_exists='append', index=True, chunksize=10000, method=tools.mysql_replace_into)
