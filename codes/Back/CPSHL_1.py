...
def generate_factor(start_date, end_date):
    ...
    n = 5
    df = p.shift().ewm(halflife=n, min_periods=5).corr(hl)
    ...
    df.to_sql('tfactorcpshl', engine, schema='factor', if_exists='append', index=True, chunksize=10000, method=tools.mysql_replace_into)
