...
def generate_factor(start_date, end_date):
    ...
    sql = sql + ' from factor.tfactorexpectedquality tm '
    for f in f_list:
        sql = sql + """
    ...
    df_new.to_sql('tfactorexpectedqualityneutral', engine, schema='factor', if_exists='append', index=True, chunksize=5000, method=tools.mysql_replace_into)
